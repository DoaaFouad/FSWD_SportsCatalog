...
categoryItem1 = Item(user_id=1, name="Cleats", description="Shoe with protusions on the sole", 
                category_id = category1.id)
                      
session.add(categoryItem1)
session.commit()

categoryItem2 = Item(user_id=1, name="Shin guards", description="Protective pad for the shin",
                category_id = category1.id)
...
categoryItem1 = Item(user_id=1, name="Crew Socks",
...
categoryItem1 = Item(user_id=1, name="Flying Disc", 
...
categoryItem1 = Item(user_id=1, name="Snowboard", 
...
categoryItem2 = Item(user_id=1, name="Goggles", 
...
categoryItem1 = Item(user_id=1, name="Shoes", 
...
categoryItem1 = Item(user_id=1, name="Skates", 
...
categoryItem1 = Item(user_id=1, name="Stick", 
